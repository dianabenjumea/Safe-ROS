...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/navigation/openslam_gmapping)
...
if(NOT "/home/ubuntu/catkin_ws/src/navigation/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/navigation/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/navigation/openslam_gmapping/${idir}'.  ${_report}")
    endif()
